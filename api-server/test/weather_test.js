...
describe('/GET (POSTIVE) weather in lat: ' + config['Tests'].lat + ' lon: ' + config['Tests'].lon  + ' ' + date + '', () => {
...
describe('/GET (NEGATIVE, wrong date) weather in lat: ' + config['Tests'].lat + ' lon: ' + config['Tests'].lon  + ' ' + config['Tests'].wrong_date + '', () => {
...
describe('/GET (NEGATIVE, wrong city) weather in lat: ' + config['Tests'].wrong_lat + ' lon: ' + config['Tests'].wrong_lon  +  ' ' + date + '', () => {
	it('It shall GET (NEGATIVE, wrong city) weather in lat: ' + config['Tests'].wrong_lat + ' lon: ' + config['Tests'].wrong_lon  +  ' ' + date , ( done ) => {
	chai.request(server)
